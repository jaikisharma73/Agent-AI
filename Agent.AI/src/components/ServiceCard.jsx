...
const ServiceCard = ({service , index}) => {
  ...
  return (
    ...
    viewport={{once:true}}
    className='relative h-50 overflow-hidden max-w-lg m-2 sm:m-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow=gray-100 dark:shadow-white/10'>
